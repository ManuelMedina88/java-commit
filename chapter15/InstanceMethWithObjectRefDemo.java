...
class HighTemp {
  ...
  // temperature as ht2.
  boolean sameThanTemp(HighTemp ht2){
...
public class InstanceMethWithObjectRefDemo {
  ...
  public static void main(String args[]){
    ...
    count = counter(weekDayHighs, HighTemp::sameThanTemp,
                      new HighTemp(89));
    System.out.println(count + " days had a hight of 89");
    ...
    count = counter(weekDayHighs2, HighTemp::sameThanTemp,
                    new HighTemp(12));
