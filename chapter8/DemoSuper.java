// A complete implementation of Box2Weight2.
package chapter8;
...
// Box2Weight2 now fully implements all constructors.
class BoxWeight2 extends Box2 {
  ...
  // constructor when all paramenter are specified
...
public class DemoSuper {
  public static void main(String args[]){
    ...
    vol = mycube.volume();
    System.out.println("Volume of volume is " + vol);
    System.out.println("Weight of volume is " + mycube.weight);
    System.out.println();
  }
}
